...
const REVIEWS = [
  ...
  { name: "Ирина",     route: "Ленинградская обл. – Тамбов",    img: REVIEW_3, text: "Нужно было срочно добраться из области до Тамбова — рейсов нет, поезд неудобный. Нашла Дальняк, договорились за 20 минут. Выехали в 5 утра, доехали чётко по времени." },
  { name: "Евгений",   route: "Тюмень – Курск",                 img: REVIEW_2, text: "Рекомендую! Удобная и быстрая доставка, комфортабельный авто. Пацаны отвечают за время, комфорт и стоимость. От всей семьи — Спасибо!" },
  { name: "Андрей",    route: "Воронеж – Богучарский р-н",      img: REVIEW_2, text: "Возили родителей в районный центр — другого варианта просто нет, автобусы не ходят. Теперь только так. Водитель помог донести вещи, вежливый, не торопил." },
  { name: "Светлана",  route: "Нижний Новгород – Тоцкий р-н",  img: REVIEW_1, text: "Муж служит, нужно было добраться с передачей. Договорились по телефону быстро, цену назвали сразу и не меняли. Доехала без нервов, всё чётко." },
  { name: "Дмитрий",   route: "Екатеринбург – Ижевск",          img: REVIEW_3, text: "Летел бизнес-встреча, поезд опоздал бы на час. Заказал такси до Ижевска — выехали в 6 утра, был на месте вовремя. Машина чистая, водитель молчаливый — это плюс." },
  { name: "Наталья",   route: "Омск – Тюмень",                  img: REVIEW_2, text: "Переезжала с двумя детьми и кучей вещей. Взяли минивэн, всё влезло. Дети не капризничали — удобно, тепло, без пересадок. Спасибо за терпение!" },
  { name: "Роман",     route: "Брянск – Новые территории",      img: REVIEW_1, text: "Не буду раскрывать детали маршрута, скажу одно — добрались. Ребята знают дорогу, не задают лишних вопросов, едут спокойно. Проверенные люди." },
  { name: "Татьяна",   route: "Кострома – Липецк",              img: REVIEW_3, text: "Искала транспорт три дня — никто не берётся, маршрут нестандартный. Дальняк взялся сразу. Назвали цену, не торговались, приехали вовремя. Теперь только к ним." },
  { name: "Михаил",    route: "Тула – Вологда",                 img: REVIEW_2, text: "Ехал на похороны, нужно было срочно. Нашёл их ночью в интернете, перезвонили через 5 минут. Выехали в 3 ночи. Водитель понял ситуацию, ехал молча — это дорого стоит." },
  { name: "Оксана",    route: "Рязань – Белгород",              img: REVIEW_1, text: "Везла маму после операции — нужен был комфортный тариф и остановки по дороге. Всё учли, не торопили, остановились три раза. Мама доехала хорошо, я спокойна." },
  { name: "Игорь",     route: "Ярославль – Челябинск",          img: REVIEW_3, text: "Длинная дорога, два водителя менялись по дороге. Доехали без задержек, машина нормальная, по дороге заехали поесть. За такое расстояние — отличный результат." },
];
