...
export default function Index() {
  ...
  useSeo({
    ...
    description: "Заказать межгородное такси по России по фиксированной цене. Работаем с 2014 года, автопарк для дальних рейсов: седаны, кроссоверы, минивэны. Звоните +7 (995) 645-51-25 круглосуточно.",
    path: "/info",
